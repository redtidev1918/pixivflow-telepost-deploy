...
Status: ACTIVE
Progress: Step 1 (manifest/proxy) DONE; Step 2 (MediaAsset) + Step 3/4 (Artifact type + DownloadedArtifact additive fields) IMPLEMENTED on PixivFlow master (08ec9d0, ec74b21). Remaining steps PLANNED.

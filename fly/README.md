...
- `deploy.your-app-name.toml`：Fly 双 Bot + PixivFlow 512 MiB 配置。
...
cp ../pixivflow-telepost-deploy/fly/deploy.your-app-name.toml ./deploy.your-app-name.toml

fly config validate -c deploy.your-app-name.toml
fly deploy -a your-app-name -c deploy.your-app-name.toml --now
```
